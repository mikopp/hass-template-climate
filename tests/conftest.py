...
def baseline_inputs(home_assistant: HomeAssistant) -> None:
    ...
    ha.call_action("input_boolean", "turn_off",
    ...
    for entity_id, value in {
        ...
        ha.call_action("input_number", "set_value",
...
def baseline_states(home_assistant: HomeAssistant, baseline_inputs: None) -> None:
    ...
    # RoomMind package.
    ha.set_state("sensor.temperatur_luftfeuchtigkeit_badezimmer_temperature", "23.4", temp)
    ...
    ha.set_state("climate.fussbodenheizung_badezimmer_local", "heat",
