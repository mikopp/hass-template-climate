...
def test_set_preset_mode_applies_target_temperature(home_assistant: HomeAssistant) -> None:
    ...
    home_assistant.call_action("climate", "set_preset_mode",
                               {"entity_id": CLIMATE, "preset_mode": "reduced"})
...
def test_set_presets_writes_back_edited_setpoint(home_assistant: HomeAssistant) -> None:
    ...
    home_assistant.call_action("climate", "set_temperature",
                               {"entity_id": CLIMATE, "temperature": 23.5})
    home_assistant.assert_entity_state(
